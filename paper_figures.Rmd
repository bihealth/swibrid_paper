...
do ridge regression from training to testing or validation data (take out subclass and atypical)

```{r Fig4G, fig.width=2. * fig_scale, fig.height=1.5 * fig_scale}
set.seed(1)
train.here <- train & !(human.meta[train,'Diagnosis'] %in% c('Subclass','Atypical'))
...
```{r Fig4H, fig.width=5.5 * fig_scale, fig.height=5.5 * fig_scale}
