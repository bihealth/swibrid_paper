...
```{r FigS4X2, fig.width=2.25 * fig_scale, fig.height=2 * fig_scale}
tmp <- FB.data.pooled %>%
...
```{r FigS4D, fig.width=2.5 * fig_scale, fig.height=2 * fig_scale}
...
```{r FigS4X4, fig.width=3 * fig_scale, fig.height=2.5 * fig_scale}
pvals <- list()
for (x in c("Tetanus",
            "Diphteria",
            "PnPS")) {
...
```{r FigS4X5, fig.width=5.5 * fig_scale, fig.height=3.5 * fig_scale}
